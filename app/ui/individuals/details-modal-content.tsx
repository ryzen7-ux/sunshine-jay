...
import { IndividualMemberLoanTable } from "./member-loans-table";
      ...
      <div className="w-full border rounded-md py-4">
        <div className="flex flex-col gap-3 pb-4 px-2">
          <div className="flex gap-3">
            <Avatar className="w-20 h-20 text-large mb-auto" />
            <div className="flex flex-col">
              ...
              <p className="pt-1 text-sm text-default-600 ">
                <strong>Business Nature:</strong> {memberData.business}
              </p>
              <p className="pt-1 text-sm text-default-600">
