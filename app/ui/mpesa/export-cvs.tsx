...
export function ExportMpesaCvs({ ginvoices }: { ginvoices: any }) {
  ...
  return (
    <RadixCard className="bg-pink-600 pb-1.5 pt-0 mt-4">
      <div className="flex flex-col md:flex-row gap-8 w-full rounded-lg  py-8 px-2 bg-gray-300 ">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex gap-2 items-center w-full">
            ...
            <input
              ...
              focus:outline-none focus:border-green-500 focus:ring-green-500
             shadow-sm hover:border-green-400 w-full"
              value={fromForm}
              onChange={(e) => {
