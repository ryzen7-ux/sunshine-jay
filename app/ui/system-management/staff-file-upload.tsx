...
export const StaffFileUpload: React.FC<FileUploadProps> = ({
  userType,
  fileUrl,
  member,
  itemId,
  ...
  maxFileSize = type === "application" ? 20 * 1024 * 1024 : 8 * 1024 * 1024, // 20MB/8MB
}) => {
        ...
        <div>
          ...
          >
            <input
              ...
              accept={type === "application" ? ".pdf" : acceptedTypes.join(",")}
              className="hidden"
            />
